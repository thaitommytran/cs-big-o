...
// ANSWER: No, the for loop stops when count is equal to 4. Runtime complexity will still be constant.
...
// ANSWER: Size complexity is dependant on the length of the input string
